...
-- AddForeignKey
ALTER TABLE "Analytics" ADD CONSTRAINT "Analytics_CategoryName_fkey" FOREIGN KEY ("CategoryName") REFERENCES "Category"("CategoryName") ON DELETE RESTRICT ON UPDATE CASCADE;
